...
const features = [
  {
    ...
    title: "Benefits Hub",
    description:
      "Unlock exclusive student discounts on your favorite brands, software, and services across India.",
    href: "/benefits",
  },
  {
    ...
    description:
      "Discover and join vibrant student communities, from coding clubs to cultural societies.",
    href: "/clubs",
  },
  {
    ...
    description:
      "Stay updated with the latest workshops, seminars, and fests happening on your campus.",
    href: "/events",
  },
];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="max-w-xl text-lg text-foreground/80">
                Welcome to OnCampus IET DAVV! The single platform to discover
                student benefits, join exciting clubs, and never miss an event.
              </p>
        ...
        <section
          id="features"
          className="py-20 md:py-28 bg-gray-100 dark:bg-gray-900 transition-colors duration-300"
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-lg text-foreground/70">
                From exclusive deals to campus happenings, we've got you
                covered.
              </p>
            </div>
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
              {features.map(feature => (
                <Card
                  key={feature.title}
                  className="text-center flex flex-col items-center p-8 bg-card dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300 transform hover:-translate-y-2 shadow-lg hover:shadow-2xl rounded-2xl"
                >
                  ...
                  <p className="mt-2 text-sm text-foreground/60 flex-grow">
                    {feature.description}
                  </p>
        ...
        <section id="recommendations" className="py-20 md:py-28">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-lg text-foreground/70">
                Tell us what you're passionate about, and our AI will curate a
                list of benefits, clubs, and events just for you.
              </p>
            </div>
            <div className="mt-12 max-w-4xl mx-auto">
              <Card className="bg-white dark:bg-gray-900 shadow-xl border-border/80 rounded-2xl transition-colors duration-300">
